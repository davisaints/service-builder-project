...
public class H7G5EntryLocalServiceWrapper
	...
	/**
	 * Adds the h7g5 entry to the database. Also notifies the appropriate model
	 * listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect H7G5EntryLocalServiceImpl for overloaded
	...
	/**
	 * Creates a new h7g5 entry with the primary key. Does not add the h7g5 entry to
	 * the database.
	 *
	...
	/**
	 * Deletes the h7g5 entry from the database. Also notifies the appropriate model
	 * listeners.
	 *
	 * <p>
	 * <strong>Important:</strong> Inspect H7G5EntryLocalServiceImpl for overloaded
	...
	/**
	 * Deletes the h7g5 entry with the primary key from the database. Also notifies
	 ...
	 * @return the h7g5 entry that was removed
	 * @throws PortalException if a h7g5 entry with the primary key could not be
	 *                         found
	 */
	@Override
	 ...
	 * <code>com.liferay.h7g5.model.impl.H7G5EntryModelImpl</code>.
	 * </p>
	 *
	 * @param dynamicQuery the dynamic query
	...
	/**
	 * Updates the h7g5 entry in the database or adds it if it does not yet exist.

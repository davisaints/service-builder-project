...
@Component(property = {
		...
		"com.liferay.portlet.display-category=category.sample", "javax.portlet.display-name=H7G5"
...
public class H7G5Portlet extends GenericPortlet {
	...
	protected void doView(
		...
		System.out.println("Requesting H7G5Portlet # doView");

		PrintWriter printWriter = renderResponse.getWriter();

		printWriter.println("Hi, H7G5!");
